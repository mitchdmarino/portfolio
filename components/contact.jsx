...
export default function Contact() {
  ...
  return (
    <section id="contact" className=" p-10 text-[#4D243D]">
          ...
          <div className="md:flex mx-auto align-center justify-center">
            ...
            <div className="w-[300px] mt-10 text-center mx-auto md:mx-10">
            <a
              className="hover:scale-125 mt-5 text-xl  lg:text-2xl"
            ...
            <a
              ...
              rel="noreferrer"
            >
            <div className="w-[200px] mx-auto mt-10 md:mt-0">
